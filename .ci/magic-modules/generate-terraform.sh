...
bundle exec compiler -v beta -p products/compute -t Address,Subnetwork,ForwardingRule,VpnTunnel -e terraform -o "${GOPATH}/src/github.com/terraform-providers/terraform-provider-google/"
