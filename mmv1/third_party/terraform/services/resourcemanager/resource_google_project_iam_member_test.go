		...
		Steps: []resource.TestStep{
			{
				...
				ExpectError: regexp.MustCompile("invalid value \"admin@hashicorptest.com\" for member \\(IAM members must have one of the values outlined here: https://docs.cloud.google.com/billing/docs/reference/rest/v1/Policy#Binding\\)"),
			},
			{
