...
Creates a new Google SQL SSL Cert on a Google SQL Instance. For more information, see the [official documentation](https://docs.cloud.google.com/sql/), or the [JSON API](https://docs.cloud.google.com/sql/docs/mysql/admin-api/v1beta4/sslCerts).
