...
and
[API](https://docs.cloud.google.com/compute/docs/reference/latest/instanceTemplates).
...
* `machine_type` - (Required) The machine type to create.
    ...
    More advanced machine types like [z3](https://docs.cloud.google.com/compute/docs/storage-optimized-machines) will
...
* `enable_display` - (Optional, [Beta](https://terraform.io/docs/providers/google/guides/provider_versions.html)) Enable [Virtual Displays](https://docs.cloud.google.com/compute/docs/instances/enable-instance-virtual-display#verify_display_driver) on this instance.
