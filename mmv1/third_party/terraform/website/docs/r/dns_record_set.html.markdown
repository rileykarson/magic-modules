...
Manages a set of DNS records within Google Cloud DNS. For more information see [the official documentation](https://docs.cloud.google.com/dns/records/) and
[API](https://docs.cloud.google.com/dns/api/v1/resourceRecordSets).
