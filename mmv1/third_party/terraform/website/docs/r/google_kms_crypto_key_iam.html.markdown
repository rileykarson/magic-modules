...
* `condition` - (Optional, [Beta](https://terraform.io/docs/providers/google/provider_versions.html)) An [IAM Condition](https://docs.cloud.google.com/iam/docs/conditions-overview) for a given binding.
