...
[the official documentation](https://docs.cloud.google.com/storage/docs/pubsub-notifications)
and
[API](https://docs.cloud.google.com/storage/docs/json_api/v1/notifications).
...
See [the notifications documentation](https://docs.cloud.google.com/storage/docs/gsutil/commands/notification) for more details.
