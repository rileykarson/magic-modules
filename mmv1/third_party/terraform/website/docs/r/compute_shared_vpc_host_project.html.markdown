...
[Shared VPC](https://docs.cloud.google.com/compute/docs/shared-vpc)
feature for a project, assigning it as a Shared VPC host project.

For more information, see,
[the Project API documentation](https://docs.cloud.google.com/compute/docs/reference/latest/projects),
