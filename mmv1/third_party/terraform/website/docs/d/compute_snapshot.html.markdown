...
* [API documentation](https://docs.cloud.google.com/compute/docs/reference/rest/v1/snapshots)
* How-to Guides
    * [Official Documentation](https://docs.cloud.google.com/compute/docs/disks/create-snapshots)
...
* `filter` - (Optional) A filter to retrieve the compute snapshot.
    See [API filter parameter documentation](https://docs.cloud.google.com/compute/docs/reference/rest/v1/snapshots/list#body.QUERY_PARAMETERS.filter) for reference.
