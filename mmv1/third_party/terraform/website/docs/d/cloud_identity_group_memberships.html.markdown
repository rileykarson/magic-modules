...
https://docs.cloud.google.com/identity/docs/concepts/overview#memberships

To get more information about GroupMembership, see:

* [API documentation](https://docs.cloud.google.com/identity/docs/reference/rest/v1/groups.memberships)
* How-to Guides
