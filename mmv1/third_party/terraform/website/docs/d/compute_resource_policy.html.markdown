...
Provide access to a Resource Policy's attributes. For more information see [the official documentation](https://docs.cloud.google.com/compute/docs/disks/scheduled-snapshots) or the [API](https://docs.cloud.google.com/compute/docs/reference/rest/beta/resourcePolicies).
