...
[the official documentation](https://docs.cloud.google.com/compute/docs/disks) and its [API](https://docs.cloud.google.com/compute/docs/reference/rest/v1/regionDisks).
