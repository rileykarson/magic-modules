...
Get service account public key. For more information, see [the official documentation](https://docs.cloud.google.com/iam/docs/creating-managing-service-account-keys) and [API](https://docs.cloud.google.com/iam/reference/rest/v1/projects.serviceAccounts.keys/get).
