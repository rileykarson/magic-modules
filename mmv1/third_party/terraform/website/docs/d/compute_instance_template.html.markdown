...
and
[API](https://docs.cloud.google.com/compute/docs/reference/rest/v1/instanceTemplates).
...
- `filter` - (Optional) A filter to retrieve the instance templates.
    See [API filter parameter documentation](https://docs.cloud.google.com/compute/docs/reference/rest/v1/instanceTemplates/list#body.QUERY_PARAMETERS.filter) for reference.
