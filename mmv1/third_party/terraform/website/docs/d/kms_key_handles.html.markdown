...
[the official documentation](https://docs.cloud.google.com/kms/docs/resource-hierarchy#key_handles)
and
[API](https://docs.cloud.google.com/kms/docs/reference/rest/v1/projects.locations.keyHandles/list).
